...
const slides = [
  ...
  },
  {
    ...
    title: (
      <>
        To be a trusted research partner delivering community-based evidence
        that informs policy, improves governance, and advances social well-being
      </>
    ),
  },
];
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-8 lg:px-12 grid grid-cols-1 md:grid-cols-2 items-center gap-12 py-12 pb-6">
        ...
        <div className="flex flex-col justify-center">
          <div className="min-h-[180px] md:min-h-[220px] flex flex-col justify-center">
            <h1
              ref={textRef}
              className="text-lg md:text-2xl font-semibold leading-snug text-gray-900 mt-[20vh]"
            >
