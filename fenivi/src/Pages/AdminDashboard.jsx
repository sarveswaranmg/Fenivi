      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-4 items-start">
          <div className="flex-1">
            <label className="block text-sm font-medium mb-2">Thumbnail (single)</label>
            <input
              ...
              required
            />
            {thumbnailFile && <div className="text-sm mt-2">{thumbnailFile.name}</div>}
          </div>

          <div className="flex-1">
            <label className="block text-sm font-medium mb-2">Gallery (up to 10)</label>
            <input
              id="admin-gal-input"
              type="file"
              accept="image/*"
            ...
            {galleryFiles.length > 0 && (
              <div className="text-sm mt-2">{galleryFiles.length} file(s) selected</div>
            )}
          </div>
        </div>
